...
;(async () => {
  ...
  const PacketV0 = await import(packageV0)
  ...
  new Benchmark.Suite('serializeIlpPrepare')
    .add('v0', function () {
      PacketV0.serializeIlpPrepare(prepareObject)
    })
    .add('v1', function () {
  ...
  new Benchmark.Suite('deserializeIlpPrepare')
    .add('v0', function () {
      PacketV0.deserializeIlpPacket(prepareBuffer)
    })
    .add('v1', function () {
  ...
  new Benchmark.Suite('serializeIlpFulfill')
    .add('v0', function () {
      PacketV0.serializeIlpFulfill(fulfillObject)
    })
    .add('v1', function () {
  ...
  new Benchmark.Suite('deserializeIlpFulfill')
    .add('v0', function () {
      PacketV0.deserializeIlpFulfill(fulfillBuffer)
    })
    .add('v1', function () {
  ...
  new Benchmark.Suite('serializeIlpReject')
    .add('v0', function () {
      PacketV0.serializeIlpReject(rejectObject)
    })
    .add('v1', function () {
  ...
  new Benchmark.Suite('deserializeIlpReject')
    .add('v0', function () {
      PacketV0.deserializeIlpReject(rejectBuffer)
    })
    .add('v1', function () {
